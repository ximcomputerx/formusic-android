...
public class NotifyUtil {
    ...
    public NotifyUtil(Context context, int ID) {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
            ...
            cBuilder.setChannelId(CHANNEL_ID);
        }
...
//                requestCode, intent, FLAG);
    ...
    public void setcBuilder(NotificationCompat.Builder cBuilder) {
...
//                requestCode, intent, FLAG);
    ...
    public void notify_progress(PendingIntent pendingIntent, int smallIcon,
        ...
        setCompatBuilder(pendingIntent, smallIcon, ticker, title, content, true, false, false);
        cBuilder.setProgress(100, 0, false);
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            cBuilder.setColor(Color.argb(0xff, 0x5d, 0x87, 0xf1));
        }
        sent();
    }

    public void update_progress(int incr) {
        // 参数：1.最大进度， 2.当前进度， 3.是否有准确的进度显示
        cBuilder.setProgress(100, incr, false);
    ...
    public void update_complete(int id) {
        cBuilder.setContentText("下载完成").setProgress(0, 0, false);
    ...
    public void update_error(int id) {
    ...
    public void notify_button(PendingIntent pendingIntent, int smallIcon, int leftbtnicon, String lefttext, PendingIntent leftPendIntent, int rightbtnicon, String righttext, PendingIntent rightPendIntent, String ticker,
                              String title, String content, boolean sound, boolean vibrate, boolean lights) {
